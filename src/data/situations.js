// Situation definitions and phrase banks used by the roleplay tutor.
...
export const EXTRA_SITUATION_PHRASES = {
  restaurant: [
    {
...
export function getSituationPhrases(situation) {
...
export function formatTutorPhraseList(situation, langCode) {
